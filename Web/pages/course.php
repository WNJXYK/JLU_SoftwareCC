    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-1 col-sm-12">
                ...
                <a class="nav-link <?if ($course_navstate[0]){?>active<?php } ?>" id="vert-tabs-home-tab" data-toggle="pill" href="#" role="tab" aria-controls="vert-tabs-home" aria-selected="true">Home</a>
                <a class="nav-link <?if ($course_navstate[1]){?>active<?php } ?>" id="vert-tabs-assignments-tab" data-toggle="pill" href="#" role="tab" aria-controls="vert-tabs-assignments" aria-selected="false">Assignments</a>
                <a class="nav-link <?if ($course_navstate[2]){?>active<?php } ?>" id="vert-tabs-syllabus-tab" data-toggle="pill" href="#" role="tab" aria-controls="vert-tabs-syllabus" aria-selected="false">Syllabus</a>
                <a class="nav-link <?if ($course_navstate[3]){?>active<?php } ?>" id="vert-tabs-modules-tab" data-toggle="pill" href="#" role="tab" aria-controls="vert-tabs-modules" aria-selected="false">Modules</a>
                <a class="nav-link <?if ($course_navstate[4]){?>active<?php } ?>" id="vert-tabs-discussions-tab" data-toggle="pill" href="#" role="tab" aria-controls="vert-tabs-discussions" aria-selected="false">Discussions</a>
                <a class="nav-link <?if ($course_navstate[5]){?>active<?php } ?>" id="vert-tabs-gardes-tab" data-toggle="pill" href="#" role="tab" aria-controls="vert-tabs-grades" aria-selected="false">Grades</a>
                </div>
            </div>
